...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $uPassword = $request->has('pass') ? $request->get('pass') : '';

        $userInfo = User::where('email', '=', $uEmail)->where('password', '=', $uPassword)->first();
        ...
        if(isset($userInfo) && $userInfo != null) {
            ...
            return redirect()->back();  //If there isn't any data then it will redirect the same page.
        }
    }
